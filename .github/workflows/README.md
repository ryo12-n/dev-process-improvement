...
| ワークフロー | トリガー | 用途 |
|-------------|---------|------|
| `initiative-dispatcher.yml` | Issue コメント (`@ai-task`) | コマンド解析・ルーティング |
| `initiative-wallbash.yml` | workflow_dispatch | 壁打ちフェーズ（提案作成） |
