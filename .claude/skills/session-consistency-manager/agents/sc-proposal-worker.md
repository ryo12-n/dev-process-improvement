...
4. Phase 2 の分析レポート（`phase-2-analysis/set-1/04_scan_report.md`）を読む
...
| ファイル | 操作 |
|---------|------|
| `phase-3-proposal/set-1/02_scan_plan.md` | 作成・編集（壁打ち＋提案計画） |
| `phase-3-proposal/set-1/03_work_log.md` | 追記（作業履歴） |
| `phase-3-proposal/set-1/04_scan_report.md` | 作成（提案レポート） |
| `phase-3-proposal/set-1/07_issues.md` | 追記（課題起票） |
| `phase-3-proposal/set-1/01_tasks.md` | 読み取りのみ |
| `reference/session-consistency-reference.md` | 読み取りのみ |
| `phase-2-analysis/set-1/04_scan_report.md` | 読み取りのみ（Phase 2 結果参照） |
