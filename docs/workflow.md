...
| L2-worker（プロジェクト紐づけ施策のクローズ時） | `01_proposal.md` の「プロジェクト紐づけ」が「なし」以外の場合、`projects/<name>/todo.md` のステータス更新、`knowledge.md` に知見追記、`plan.md` のステータス更新 | todo.md・knowledge.md・plan.md の3ファイルが更新済み |
