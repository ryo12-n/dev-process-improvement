...
| 3 | docs/workflow.md・テンプレート修正 | batch-template-doc-fixes | 中 | 完了 | 6件。BL-054は既存で充足、BL-077は部分変換済み |
| 4 | ルール・ポリシー軽微追記 | batch-rule-policy-minor-additions | 中 | 完了 | 7件。全件追記完了 |
| 5 | aidd関連軽微修正 | batch-aidd-minor-fixes | 中 | 未着手 | 6件、CLI --add-dir 環境必要 |
| 6 | スキル・セッション微調整 | batch-skill-session-tweaks | 低 | 進行中 | 7件（BL-017,027,040,042,043,052,062）。T-001〜T-007 実施完了、評価待ち |
| 7 | 非施策セッションGHA自動化 | (M統合) BL-055+BL-057 | 中 | 未着手 | M分類統合候補 |
| 8 | workflow.md網羅性改善 | (M統合) BL-054+BL-065 | 中 | 完了 | バッチ消化済み（batch-template-doc-fixes） |
